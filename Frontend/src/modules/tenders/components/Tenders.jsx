    ...
    <Container className="mt-4 mb-5">
      <div className="mb-4">
        ...
        <p className="text-muted">
          Browse available tenders and submit your bid.
        </p>
      </div>
      ...
      {tenders.length === 0 ? (
        <Alert variant="secondary">No published tenders found.</Alert>
      ) : (
        <Row>
          {tenders.map((tender) => (
              ...
              <Card className="shadow-sm h-100 border-0">
                <Card.Body>
                  ...
                  <div className="d-flex justify-content-between align-items-start">
                    ...
                    <Badge bg="success">{tender.status}</Badge>
                  </div>
                  ...
                  <p className="text-muted">{tender.description}</p>
                  ...
                  <p>
                    <strong>Client:</strong> {tender.client_name}
                  </p>
                </Card.Body>
